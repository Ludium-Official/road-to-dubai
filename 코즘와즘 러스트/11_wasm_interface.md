# 11. WebAssembly Interface
> WebAssembly(Wasm)가 런타임 실행되는 환경에 대해 이해하기 위해 Wasm 인터페이스 개념을 다룬다.

## 목차
0. WebAssembly Interface(WASI)
1. WASI 특징 
   1. Portability 휴대성
   2. Security 보안
   3. 모듈식 설계
...
- 호스트 환경이 프로그램이 할 수 있는 작업을 제한할 수 있다. 이렇게 하면 프로그램이 운영 체제 전체 권한을 갖고 위험한 작업을 하지 못하게 막을 수 니
